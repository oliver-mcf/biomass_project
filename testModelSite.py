...
def spatial_cv(train_filename, test_filename, label, trees, folder):
    ...
    model_scatter(y_test, y_pred, folder, label, model = 0)
    model_hist(y_test, y_pred, folder, label, model = 0)
...
if __name__ == '__main__':
    ...
    train_site = f'/home/s1949330/Documents/scratch/diss_data/pred_vars/input_final/{args.label}_{args.trainSite}_MODEL_INPUT_GEO_FINAL.csv'
    test_site = f'/home/s1949330/Documents/scratch/diss_data/pred_vars/input_final/{args.label}_{args.testSite}_MODEL_INPUT_GEO_FINAL.csv'

    # Perform spatial cross validation
    spatial_cv(train_site, test_site, args.label, args.trees, args.folder)

...
def train(x_train, y_train, label, trees, site = ''):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--trees', type = str, help = 'Number of estimators to train random forest model')
    ...
    # Train RF model
    train(x_train, y_train, args.label, args.trees, args.site)

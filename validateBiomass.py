...
def validation_stats(field, gedi, site, year):
    ...
    pprint(stats_df)
    stats_df.to_csv(f'/home/s1949330/data/diss_data/model/yes_geo/All/predict/validate/{site}_{year}_VALIDATION_STATS.csv', index = False)
...
if __name__ == '__main__':
    ...
    for site in site_list:
        for year in year_list:
            ...
            pred = f'/home/s1949330/data/diss_data/model/yes_geo/All/predict/{site}_{year}_PREDICT_AGB_COVER.tif'
    ...
    pprint(validation)
    validation.to_csv('/home/s1949330/data/diss_data/model/yes_geo/All/predict/validate/BOTH_ALL_VALIDATION.csv', index = False)
